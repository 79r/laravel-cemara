...
<li class="breadcrumb-item active">Jo Waiting List</li>
</ol>
@endsection
...
<div id="job-list">
    ...
    <div class="text-center mt-3 mb-3">
        <div class="btn-group" role="group">
            ...
            <a href="{{ route('job-waiting-list') }}" class="btn btn-sm btn-danger"><i class="mdi mdi-checkbox-marked-circle-outline"></i> Jo Waiting List</a>
...
<script>
var url = "{{ route('ajaxjo-waiting-list') }}";
var page = 1;
var current_page = 1;
var total_page = 0;
var is_ajax_fire = 0;
