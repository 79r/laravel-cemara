    ...
    <div class="row">
        <div class="col-xl-7">
            <div class="card pl-sm-0 pl-md-4">
                <div class="bg-transparent">
                    <div class="my-3">
                        <a href="{{ route('categories.index') }}/{{ $category->id }}/edit" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="mdi mdi-pencil"></i> <span>Edit item ini</span>
                        </a>
                    </div>
                    <h5 class="header-title-lg mb-3">{{ $category->name }}</h5>
                </div>
                        ...
                        <div class="media my-2">
                            <div class="media-body">
                                ...
                                @if (!empty($category->notes))
                                    <h6 class="mb-0">{{ $category->notes }}</h6>
                                @else
        ...
        <div class="col-xl-5">
            ...
            <div class="img-thumbnail rounded">
                <img class="img-fluid" src="{{ url($category->image_url) }}" alt="">
            </div>
            @else
...
<div class="text-center mt-5">
    <h4 class="header-title">Data Inventory dari Kategori {{ $category->name }}</h4>
</div>
